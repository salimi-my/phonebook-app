<footer class="footer">
  <div class="text-center">
    <span class="footer-text">Created by <a href="https://www.salimi.my" target="_blank" rel="noopener noreferer" class="link-secondary">Salimi</a> &copy; <?php echo date('Y'); ?></span>
  </div>
</footer>
